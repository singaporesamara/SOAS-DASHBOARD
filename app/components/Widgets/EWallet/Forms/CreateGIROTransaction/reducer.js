...
import { BACK_TO_FORM, TRANSACTION_FINISHED } from './constants';

const initialWidget = { transaction: { completed: false } };
const initialState = fromJS(merge({}, initialWidget, DEFAULT_WIDGET_STATE));

function eWalletCreateGIROTransactionFormReducer(state = initialState, action) {
  switch (action.type) {
...
export default eWalletCreateGIROTransactionFormReducer;
